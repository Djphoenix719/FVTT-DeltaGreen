...
const baseArgs = {
    entries: ['./src/system/Setup.ts'],
    sourceType: 'module',
    debug: true,
    standalone: 'delta-green',
};
...
async function copyAssets() {
    gulp.src('system.json').pipe(gulp.dest(destFolder));
    gulp.src('template.json').pipe(gulp.dest(destFolder));
